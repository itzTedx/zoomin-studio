...
export const Flower_11 = () => (
  <svg
    className="coolshapes flower-11"
    height="400"
    width="400"
    fill="none"
    viewBox="0 0 200 200"
  ...
  >
    <g clipPath="url(#cs_clip_1_flower-11)">
      <mask
        height="200"
        id="cs_mask_1_flower-11"
      ...
      <g mask="url(#cs_mask_1_flower-11)">
        <path d="M200 0H0v200h200V0z" fill="#fff" />
        <path d="M200 0H0v200h200V0z" fill="#F2371F" fillOpacity="0.181" />
        <g filter="url(#filter0_f_748_4615)">
          <path d="M120.25 56h-105v119h105V56z" fill="#FFE500" />
          <path d="M223.5 0H100.25v140.875H223.5V0z" fill="#FF28DD" />
        </g>
      </g>
    </g>
    <g style={{ mixBlendMode: "overlay" }} mask="url(#cs_mask_1_flower-11)">
      <path
        d="M200 0H0v200h200V0z"
        fill="gray"
        stroke="transparent"
        filter="url(#cs_noise_1_flower-11)"
      />
    </g>
    <defs>
      <filter
      ...
      <clipPath id="cs_clip_1_flower-11">
